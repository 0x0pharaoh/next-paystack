...
var PaystackButton = function (_a) {
    ...
    return (jsx("button", { className: className, onClick: function () { return initializePayment({ config: config, onSuccess: onSuccess, onClose: onClose }); }, disabled: disabled, children: text || children }));
};
...
var PaystackProvider = function (_a) {
    ...
    var initializePayment = usePaystackPayment(config);
    return (jsx(PaystackContext.Provider, { value: { config: config, initializePayment: initializePayment, onSuccess: onSuccess, onClose: onClose }, children: children }));
};
...
var PaystackConsumer = forwardRef(function (_a, ref) {
    ...
    return (jsx(PaystackProvider, __assign({}, others, { onSuccess: onSuccess, onClose: onClose, children: jsx(PaystackConsumerChild, { ref: ref, children: children }) })));
});
